  ...
  return (
    <main className="w-full max-w-3xl px-4 py-16">
      ...
      <section className="mb-8" aria-labelledby="mission-heading">
        <h2 id="mission-heading" className="text-xl font-semibold text-gray-800 mb-2">
          Our Mission
        </h2>
      ...
      <section className="mb-8" aria-labelledby="approach-heading">
        <h2 id="approach-heading" className="text-xl font-semibold text-gray-800 mb-2">
      ...
      <section aria-labelledby="trust-heading">
        <h2 id="trust-heading" className="text-xl font-semibold text-gray-800 mb-2">
