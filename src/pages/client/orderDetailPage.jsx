...
export default function OrderDetailPage() {
  ...
  return (
    <div className="w-full max-w-3xl px-4 py-8">
      ...
      <div className="bg-card rounded-2xl shadow-md p-6 mt-4">
        <div className="flex justify-between items-start flex-wrap gap-2">
          ...
          <div className="flex gap-2">
            ...
            <span className="capitalize bg-muted text-foreground px-3 py-1 rounded-full text-sm font-medium">
              {order.status}
            </span>
          </div>
        </div>
        ...
        <div className="mt-4 text-sm text-muted-foreground">
          <p>
            <span className="font-medium text-foreground">Delivery Address:</span> {order.address}
          </p>
          <p>
