...
export default function ConciergePage() {
  ...
  return (
    <div className="w-full max-w-3xl px-4 py-10">
      <h1 className="text-2xl font-bold text-gray-800 mb-2">AI Beauty & Style Concierge</h1>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 bg-white rounded-2xl shadow-md p-6">
        <label className="flex flex-col gap-1">
          <span className="text-sm font-medium text-gray-700">What are you looking for?</span>
          <textarea
            value={message}
        ...
        <label className="flex flex-col gap-1 w-48">
          <span className="text-sm font-medium text-gray-700">Budget (optional)</span>
          <input
            type="number"
            min="1"
            value={budget}
